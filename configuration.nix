...
{
  imports = [
    ./hardware-configuration.nix # Include hardware config - you'll need to generate this on your actual server
  ];

  # Use the system-level Nix package manager
  nix = {
  ...
  boot.loader.grub.device = "/dev/sda"; # Adjust based on your VPS
  ...
  users.users.minecraft = {
    ...
    openssh.authorizedKeys.keys = [
      ...
      # "ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAIM7ybmfon2nYEYN8U/W/9NWzNHijjZm8aFFBlACY9Lw1 your-key"
    ];
  };
  ...
  services.minecraft-servers = {
    ...
    servers.bm2 = {
      ...
      package = pkgs.fabricServers.fabric-1_20_1.override {
        loaderVersion = "0.15.6"; # Use a compatible Fabric loader version
      };
